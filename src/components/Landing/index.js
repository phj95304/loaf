    ...
    return(
      ...
      <Card>
        <CardBody className = "page1">
          ...
          <br/><br/>
          <CardText className = "page1_text">√ LOAF의 의미는 중의적이다.</CardText>
          <CardText className = "page1_text">√ LOAF는 빵 덩어리에 불과 할 수도 있지만</CardText>
          <CardText className = "page1_text">√ 많은 이에게 꿈과 희망을 줄 수 있다.</CardText>
          <br/><br/> <br/>
        </CardBody>
        ...
        <CardFooter body inverse style={{ backgroundColor: '#c4abc9', borderColor: '#c4abc9' }}>
          ...
          <br/>
          <CardText className = "page2_text">√ LOAF의 의미는 중의적이다.</CardText>
          <CardText className = "page2_text">√ LOAF는 빵 덩어리에 불과 할 수도 있지만</CardText>
          <CardText className = "page2_text">√ 많은 이에게 꿈과 희망을 줄 수 있다.</CardText>
      ...
      <Card>
        <CardBody className = "page3">
          ...
          <br/>
          <CardText className = "page3_text">√ LOAF의 의미는 중의적이다.</CardText>
          <CardText className = "page3_text">√ LOAF는 빵 덩어리에 불과 할 수도 있지만</CardText>
          <CardText className = "page3_text">√ 많은 이에게 꿈과 희망을 줄 수 있다.</CardText>
